...
export class AppointmentModalComponent implements AfterViewInit {
  ...
  featuredCards: any[] = [
    ...
    },
    {
      ...
      id: 22,
      description: `Become a Featured Practitioner and your practice will be featured throughout Medicaltalk.tube`,
  ...
  nextToApplication() {
    ...
    const applicationObject = {
      appointment: {
        ...
        doctorProfileId: this.data.practitionerProfileId,
        doctorName: this.data.practitionerName,
      },
      topics: topics,
      slug: this.data.slug,
    };
